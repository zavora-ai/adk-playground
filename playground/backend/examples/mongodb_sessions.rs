...
use adk_rust::session::{
    CreateRequest, DeleteRequest, GetRequest, ListRequest, MongoSessionService, SessionService,
};
...
async fn main() -> anyhow::Result<()> {
    ...
    let db_url = std::env::var("MONGODB_URL").unwrap_or_else(|_| {
        "mongodb://adk:adk_playground@localhost:27017/?retryWrites=false".into()
    });
